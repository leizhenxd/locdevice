...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>CL Chain Nodes Management Console</title>
...
<![endif]-->
	...
	<body>
		...
		<div class="navbar navbar-default" style="background:#307ecc" id="navbar">
			<script type="text/javascript">
			...
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-header pull-left">
					<a href="#" class="navbar-brand">
						<small>
							<i class="icon-leaf"></i>
							CL Chain Nodes Management Console
						</small>
					</a><!-- /.brand -->
				</div><!-- /.navbar-header -->
				...
				<div class="navbar-header pull-right" role="navigation">
					<ul class="nav ace-nav">
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle" style="padding-right:0px;background-color:#307ecc">
								<img class="nav-user-photo" src="/static/images/logistic/node.png" alt="Jason's Photo" />
								<span class="user-info" style="max-width:300px;">
									${Session.loginUser.userName}<br/>
									Address:${Session.loginUser.walletId}
								</span>
			...
			<div class="main-container-inner">
				...
				<div class="sidebar display" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li class="link">
							<a href="#" link="account.htm">
								<span class="menu-text">Account</span>
							</a>
						</li>
						<li class="link">
							<a href="#" link="history.htm">
								<span class="menu-text">History</span>
							</a>
						</li>
						<li class="link">
							<a href="#" link="network.htm">
								<span class="menu-text">Network</span>
							</a>
						</li>
						<li class="link">
							<a href="#" link="blockchain.htm">
								<span class="menu-text">BlockChain</span>
							</a>
						</li>
						<li class="link">
