				 ...
				 jQuery.extend(jQuery.jgrid.defaults,{
					...
					jQuery("#grid-table").jqGrid({
						...
						colModel:[
							...
							{name:'createUser',index:'createUser',width:75, sorttype:"string", editable: true},
							{name:'createTime',index:'createTime',width:80, sorttype:"string", editable: true,
